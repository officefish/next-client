...
module.exports = [
    ...
    },
    {
      ...
      pattern: /(bg|to|via|from|text|fill|stroke|border|outline)-((primary|secondary|accent|neutral)(-focus|-content|-dark)(-dark))|((info|success|warning|error)(-content|-dark)(-dark))|(base)(-100|-200|-300|-content)(-dark)/,
      variants: [
        // "first",
        // "last",
        // "odd",
