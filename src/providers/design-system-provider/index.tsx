...
import { getLocalStorageValue } from '@services/local-storage.service'
import { useRouter } from "next/router"

import {UseDesignSystemProps, DesignSystemProviderProps } from './types'  

const DesignSystemContext = createContext<UseDesignSystemProps | undefined>(undefined)
...
const DesignSystem: React.FC<DesignSystemProviderProps> = ({
    ...
    useEffect(() => {
        if (activePage)
            applyActivePage(forcedPage ?? activePage)
