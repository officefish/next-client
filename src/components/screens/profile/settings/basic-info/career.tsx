...
const BasicInfoCareer: FC = (props: Props) => {
            ...
            <StyledCollapseSectionContent>  
                ...
                <StyledSettingsForm action="">
                    <StyledSettingsField>
                        ...
                        <StyledSettingsInput type="text" value={career?.company ? career.company : ''} onChange={setCompany}/>
                    </StyledSettingsField>
                    <StyledSettingsField>
                        <StyledSettingsLabel>Role:</StyledSettingsLabel>
                        <StyledSettingsInput type="text" value={career?.role ? career.role : ''} onChange={setRole} />
                    </StyledSettingsField>
                </StyledSettingsForm> 
            </StyledCollapseSectionContent>
        </StyledCollapseSection>
