...
const StatusQuote: FC = (props: Props) => {
            ...
            <StyledCollapseSectionContent>  
                ...
                <StyledSettingsForm action="">
                    <StyledSettingsField>
                        ...
                        <textarea className="textarea textarea-bordered min-h-[3.2rem] min-w-[75%] pr-4" 
                        placeholder="Bio or something exciting" onChange={handleAreaChange} value={quote?.value}></textarea>
